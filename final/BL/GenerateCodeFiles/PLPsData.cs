...
namespace WebApiCSharp.GenerateCodeFiles
{
    public class PLPsData
    {
        ...
        public const string DISCRETE_DISTRIBUTION_FUNCTION_NAME = "AOS.SampleDiscrete"; 
        public const string NORMAL_DISTRIBUTION_FUNCTION_NAME = "AOS.SampleNormal"; 
        public const string UNIFORM_DISTRIBUTION_FUNCTION_NAME = "AOS.SampleUniform"; 
        public const string AOS_SET_NULL_FUNCTION_NAME = "AOS.SetNull"; 
        public const string AOS_IS_INITIALIZED_FUNCTION_NAME = "AOS.IsInitialized"; 
        public const string AOS_UN_INITIALIZED_FUNCTION_NAME = "AOS.Uninitialize"; 
        public const string AOS_INITIALIZED_FUNCTION_NAME = "AOS.Initialize"; 
        public const string AOS_Bernoulli_FUNCTION_NAME = "AOS.Bernoulli"; 
            ...
            if (bRosGlue.Contains("LocalVariablesInitialization"))
            {
                foreach (BsonValue bVal in bRosGlue["LocalVariablesInitialization"].AsBsonArray)
                {
                    ...
                    else
                    {
                        ...
                        oVar.Consistency = GetBsonStringField(docVar, "Consistency"); 
                        ...
                        oVar.AssignmentCode = GetBsonStringOrStringArrayField(docVar, "AssignmentCode"); 
        ...
        private List<Assignment> LoadAssignment(BsonArray bAssignmentsArray, string plpName, string plpType, out List<string> errors, EStateType assignmentLatestPointInTime, bool isCheckPrecondition = false)
        {
            ...
            foreach (BsonValue bVal in bAssignmentsArray)
            {
                ...
                oAssignment.AssignmentCode = GetBsonStringOrStringArrayField(docAssignment, "AssignmentCode");
                string iterateVar = docAssignment.Contains("IteratePreviousStateVars") ? "IteratePreviousStateVars" : docAssignment.Contains("IterateNextStateVars") ? "IterateNextStateVars" : null;
    ...
    public class CompoundVarTypePLP_Variable
    {
        ...
        public CompoundVarTypePLP_Variable() { ML_IgnoreVariable = false; }
    }
    ...
    public class DistributionSample
    {
        ...
        public DistributionSample() { Parameters = new List<string>(); }
    }
}
