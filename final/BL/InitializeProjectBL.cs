...
";
        ...
        private static void RunSolver(PLPsData data)
        {
            ...
            {
                GenerateFilesUtils.WriteTextFile(configuration.SolverPath + "/build/runSolverWrapper.sh",
                    GetRunSolverBashFile(data), true);
        ...
        private static string BuildAosSolver(PLPsData data)
        {
            ...
            string output =
                GenerateFilesUtils.RunBashCommand(
                    "cmake --build ~/AOS/AOS-Solver/build --config Release --target all -j 14 --");
        ...
        //         {
        //             solverId = SolversService.GetNextNewSolverId() - 1;
        //             SolversService.StopOrStartSolver(solverId, true,
        //                 initProj.SolverConfiguration.PlanningTimePerMoveInSeconds);
        //         }
        //
        //         AosGeneralService.DeleteCollectionsBeforeProjectInitialization();
        //         errors.AddRange(LoadPLPs(initProj.PLPsDirectoryPath, out tempRemarks));
        ...
        //         if (initProj.RunWithoutRebuild.Value)
        //         {
        //             SolversService.StopOrStartSolver(solverId, false,
        //                 initProj.SolverConfiguration.PlanningTimePerMoveInSeconds);
        //             
        //             if (!initProj.OnlyGenerateCode.Value)
        //             {
        ...
        //             {
        //                 ProjectName = plpData.ProjectName, SolverId = nextSolverId,
